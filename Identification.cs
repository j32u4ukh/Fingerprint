    ...
    public partial class Identification : Form
    {
        ...
        private void OnCaptured(CaptureResult captureResult)
        {
            try
            {
                ...
                //Debug.WriteLine(captureResult.ResultCode.ToString());
                ...
                if (count == 0)
                {
                   ...
                   // Debug.WriteLine(rightIndex);
                  //  Debug.WriteLine(resultConversion.Data);
                    count += 1;
                    //判斷時要求的提示
                ...
                else if (count == 2)
                {
                    ...
                    fmds[0] = rightIndex;
                    fmds[1] = rightThumb;
                    //Debug.WriteLine(anyFinger);
                    // See the SDK documentation for an explanation on threshold scores.
                    int thresholdScore = DPFJ_PROBABILITY_ONE * 1 / 100000;
                    //Debug.WriteLine(thresholdScore);

                    IdentifyResult identifyResult = Comparison.Identify(anyFinger, 0, fmds, thresholdScore, 2);
                    //Fmd fmd = identifyResult
                    //Debug.WriteLine("identifyResult = " + identifyResult);
                    ...
                    //以下試辦斷成功時+1
                    Debug.WriteLine(identifyResult.Indexes.Length.ToString());
